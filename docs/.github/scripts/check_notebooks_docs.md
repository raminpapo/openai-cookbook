# File Documentation: check_notebooks.py

## File Metadata
- **Path**: `.github/scripts/check_notebooks.py`
- **Size**: 1,603 bytes (1,603 characters)
- **Lines**: 62
- **Extension**: `.py`
- **Classification**: text
...
pytest .github/scripts/check_notebooks.py
```

---

*Documentation generated for `.github/scripts/check_notebooks.py`*
