# Documentation: OpenAI partners with Schibsted Media Group _ OpenAI.pdf

## File Metadata
- **Path**: `examples/data/openai_blog_pdfs/OpenAI partners with Schibsted Media Group _ OpenAI.pdf`
- **Type**: Binary file
- **Size**: 260,766 bytes (254.65 KB)
