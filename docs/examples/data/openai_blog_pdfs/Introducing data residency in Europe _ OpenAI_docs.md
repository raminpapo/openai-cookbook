# File Documentation: Introducing data residency in Europe _ OpenAI.pdf

## File Metadata
- **Path**: `examples/data/openai_blog_pdfs/Introducing data residency in Europe _ OpenAI.pdf`
- **Size**: 113,427 bytes
- **Type**: Binary file
