# Documentation: Partnering with Axios expands OpenAI’s work with the news industry _ OpenAI.pdf

## File Metadata
- **Path**: `examples/data/openai_blog_pdfs/Partnering with Axios expands OpenAI’s work with the news industry _ OpenAI.pdf`
- **Type**: Binary file
- **Size**: 198,143 bytes (193.50 KB)
