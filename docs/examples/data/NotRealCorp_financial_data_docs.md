# File Documentation: NotRealCorp_financial_data.json

## File Metadata
- **Path**: `examples/data/NotRealCorp_financial_data.json`
- **Size**: 4,479 bytes (4,479 characters)
- **Lines**: 1
- **Extension**: `.json`
- **Classification**: text
...
*Documentation generated for `examples/data/NotRealCorp_financial_data.json`*
