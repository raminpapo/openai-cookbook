# Documentation: NotRealCorp_financial_data.json

## File Metadata
- **Path**: `examples/data/NotRealCorp_financial_data.json`
- **Type**: .json file
...
**Top-level keys**: Year, Quarter, Distribution channel, Revenue ($M), Costs ($M), Customer count, Time
...
- [dbpedia_samples.jsonl](./dbpedia_samples.jsonl_docs.md)
