# File Documentation: crawl-website-embeddings.txt

## File Metadata
- **Path**: `examples/data/oai_docs/crawl-website-embeddings.txt`
- **Size**: 22,705 bytes (22,698 characters)
- **Lines**: 561
- **Extension**: `.txt`
- **Classification**: text
...
*Documentation generated for `examples/data/oai_docs/crawl-website-embeddings.txt`*
