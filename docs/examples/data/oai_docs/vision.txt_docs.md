...
>
    <IconItem
        icon={}
        color="red"
        title="Video understanding with vision"
        className="mt-6"
    >
...
<CodeSample
    title="Choosing the detail level"
    defaultLanguage="python"
    code={{
        python: `
from openai import OpenAI\n
...
File contains 447 lines with structured content.
