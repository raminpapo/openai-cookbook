# Documentation: tool-code-interpreter.txt

## File Metadata
- **Path**: `examples/data/oai_docs/tool-code-interpreter.txt`
- **Type**: .txt file
- **Size**: 13,205 bytes (12.90 KB)
- **Lines**: 359
- **Words**: 1,400
- **Characters**: 13,197
...
File contains 359 lines with structured content.
