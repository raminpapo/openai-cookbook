# Documentation: how-it-works.txt
...
<Notice
    ...
    body={
            ...
            The Assistants API is in beta and we are actively working on
            adding more functionality. Share your feedback in our{" "}
            Developer Forum!
...
File contains 578 lines with structured content.
