# File Documentation: function-calling-run-example--polling.txt

## File Metadata
- **Path**: `examples/data/oai_docs/function-calling-run-example--polling.txt`
- **Size**: 3,784 bytes (3,784 characters)
- **Lines**: 123
- **Extension**: `.txt`
- **Classification**: text
...
*Documentation generated for `examples/data/oai_docs/function-calling-run-example--polling.txt`*
