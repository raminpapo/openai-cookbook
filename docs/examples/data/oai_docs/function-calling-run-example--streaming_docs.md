# File Documentation: function-calling-run-example--streaming.txt

## File Metadata
- **Path**: `examples/data/oai_docs/function-calling-run-example--streaming.txt`
- **Size**: 4,053 bytes (4,049 characters)
- **Lines**: 125
- **Extension**: `.txt`
- **Classification**: text
...
*Documentation generated for `examples/data/oai_docs/function-calling-run-example--streaming.txt`*
