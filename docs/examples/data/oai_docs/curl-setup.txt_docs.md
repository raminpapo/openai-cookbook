# Documentation: curl-setup.txt

## File Metadata
- **Path**: `examples/data/oai_docs/curl-setup.txt`
- **Type**: .txt file
...
File contains 119 lines with structured content.
...
- [function-calling-run-example--polling.txt](./function-calling-run-example--polling.txt_docs.md)
