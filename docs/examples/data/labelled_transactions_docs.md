# File Documentation: labelled_transactions.csv

## File Metadata
- **Path**: `examples/data/labelled_transactions.csv`
- **Size**: 8,348 bytes (8,246 characters)
- **Lines**: 102
- **Extension**: `.csv`
- **Classification**: text
...
*Documentation generated for `examples/data/labelled_transactions.csv`*
