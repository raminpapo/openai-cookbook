# Documentation: SpeakerPage.tsx

## File Metadata
- **Path**: `examples/voice_solutions/one_way_translation_using_realtime_api/src/pages/SpeakerPage.tsx`
- **Type**: .tsx file
- **Size**: 10,250 bytes (10.01 KB)
- **Lines**: 288
- **Words**: 976
- **Characters**: 10,250
...
**Functions**: SpeakerPage, updatedLanguageConfigs, connectConversation, disconnectConversation, connectAndSetupClients, disconnectClients, startRecording, stopRecording, changeTurnEndType, toggleTranscriptsVisibility, to, handleRealtimeEvent

**Dependencies**: ../components/button/Button, ../components/toggle/Toggle, ../lib/wavtools/index.js, ../utils/translation_prompts.js, @openai/realtime-api-beta, react, socket.io-client
...
**Same directory**:
- [ListenerPage.tsx](./ListenerPage.tsx_docs.md)
- [Styles.scss](./Styles.scss_docs.md)
