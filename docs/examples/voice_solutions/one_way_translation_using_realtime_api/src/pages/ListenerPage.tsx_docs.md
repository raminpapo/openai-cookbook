# Documentation: ListenerPage.tsx

## File Metadata
- **Path**: `examples/voice_solutions/one_way_translation_using_realtime_api/src/pages/ListenerPage.tsx`
- **Type**: .tsx file
- **Size**: 4,415 bytes (4.31 KB)
- **Lines**: 126
- **Words**: 438
- **Characters**: 4,415
...
**Functions**: ListenerPage, const, connectServer, disconnectServer, to, playAudioChunk

**Dependencies**: ../components/button/Button, ../lib/wavtools, react, socket.io-client
...
**Same directory**:
- [SpeakerPage.tsx](./SpeakerPage.tsx_docs.md)
