# Documentation: translation_prompts.js

## File Metadata
- **Path**: `examples/voice_solutions/one_way_translation_using_realtime_api/src/utils/translation_prompts.js`
- **Type**: .js file
- **Size**: 10,008 bytes (9.77 KB)
- **Lines**: 146
- **Words**: 1,492
- **Characters**: 9,865
...
File contains 146 lines with structured content.
...
```javascript
import { ... } from './translation_prompts.js';
```
...
**Same directory**:
- [wav_renderer.ts](./wav_renderer.ts_docs.md)
