...
```bash
# Run with Node.js
node examples/voice_solutions/one_way_translation_using_realtime_api/src/utils/translation_prompts.js
```

---

*Documentation generated for `examples/voice_solutions/one_way_translation_using_realtime_api/src/utils/translation_prompts.js`*
