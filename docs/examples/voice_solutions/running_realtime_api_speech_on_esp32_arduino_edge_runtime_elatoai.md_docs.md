# Documentation: running_realtime_api_speech_on_esp32_arduino_edge_runtime_elatoai.md

## File Metadata
- **Path**: `examples/voice_solutions/running_realtime_api_speech_on_esp32_arduino_edge_runtime_elatoai.md`
- **Type**: .md file
- **Size**: 10,808 bytes (10.55 KB)
- **Lines**: 242
- **Words**: 1,303
- **Characters**: 10,750
...
Markdown documentation file: **In .env.local, set your environment variables **
