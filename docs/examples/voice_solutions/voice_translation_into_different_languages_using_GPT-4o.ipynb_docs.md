# Documentation: voice_translation_into_different_languages_using_GPT-4o.ipynb
...
File contains 494 lines with structured content.
...
```bash
jupyter notebook voice_translation_into_different_languages_using_GPT-4o.ipynb
```
...
**Same directory**:
- [one_way_translation_using_realtime_api.mdx](./one_way_translation_using_realtime_api.mdx_docs.md)
- [running_realtime_api_speech_on_esp32_arduino_edge_runtime_elatoai.md](./running_realtime_api_speech_on_esp32_arduino_edge_runtime_elatoai.md_docs.md)
- [steering_tts.ipynb](./steering_tts.ipynb_docs.md)
