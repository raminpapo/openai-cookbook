# File Documentation: one_way_translation_using_realtime_api.mdx

## File Metadata
- **Path**: `examples/voice_solutions/one_way_translation_using_realtime_api.mdx`
- **Size**: 11,180 bytes (11,178 characters)
- **Lines**: 165
- **Extension**: `.mdx`
- **Classification**: text
...
This is a text file with extension `.mdx`.
...
*Documentation generated for `examples/voice_solutions/one_way_translation_using_realtime_api.mdx`*
