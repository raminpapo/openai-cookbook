# File Documentation: Entity_extraction_for_long_documents.ipynb

## File Metadata
- **Path**: `examples/Entity_extraction_for_long_documents.ipynb`
- **Size**: 14,234 bytes (14,234 characters)
- **Lines**: 335
- **Extension**: `.ipynb`
- **Classification**: text
...
*Documentation generated for `examples/Entity_extraction_for_long_documents.ipynb`*
