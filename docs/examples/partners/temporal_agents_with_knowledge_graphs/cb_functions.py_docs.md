# Documentation: cb_functions.py

## File Metadata
- **Path**: `examples/partners/temporal_agents_with_knowledge_graphs/cb_functions.py`
- **Type**: .py file
- **Size**: 6,052 bytes (5.91 KB)
- **Lines**: 205
- **Words**: 536
- **Characters**: 6,040
...
**Functions**: load_db_from_hf, build_graph, _load_entity_maps, _load_event_temporal, _add_triplet_edge

**Dependencies**: Any, HuggingFace., datasets, db_interface, get_all_triplets, load_dataset, networkx, sqlite3, typing
