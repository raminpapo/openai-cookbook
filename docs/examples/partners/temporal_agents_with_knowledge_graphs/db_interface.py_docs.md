# Documentation: db_interface.py

## File Metadata
- **Path**: `examples/partners/temporal_agents_with_knowledge_graphs/db_interface.py`
- **Type**: .py file
...
**Functions**: make_connection, _drop_all_tables, _create_lite_tables, view_db_table, insert_transcript, insert_chunk, insert_triplet, get_all_triplets, get_all_unique_predicates, insert_entity, get_all_canonical_entities, insert_canonical_entity, update_entity_references, remove_entity, insert_event, has_events, update_events_batch

**Dependencies**: Any, Entity, e, models, old_id, os, pandas, safe_iso, sqlite3, the, typing, utils, uuid
