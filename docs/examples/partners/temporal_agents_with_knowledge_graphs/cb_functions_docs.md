...
```bash
# Run this file
python examples/partners/temporal_agents_with_knowledge_graphs/cb_functions.py

# Run tests (if this is a test file)
pytest examples/partners/temporal_agents_with_knowledge_graphs/cb_functions.py
```

---

*Documentation generated for `examples/partners/temporal_agents_with_knowledge_graphs/cb_functions.py`*
