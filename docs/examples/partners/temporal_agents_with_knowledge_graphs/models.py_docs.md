...
**Classes**: RawEntity, Entity, TemporalType, StatementType, TemporalEvent

**Functions**: from_raw, triplets_json, parse_triplets_json, set_expired_at

**Dependencies**: BaseModel, StrEnum, a, datetime, enum, json, pydantic, uuid
