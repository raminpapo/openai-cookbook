...
**Functions**: _run_rag, _summarize_rag_response, generate_rag_output, run_web_search, index_documents

**Dependencies**: FastMCP, OpenAI, agents, mcp.server.fastmcp, openai, os, set_tracing_export_api_key
...
**Same directory**:
- [database.db](./database.db_docs.md)
- [mcp_powered_agents_cookbook.ipynb](./mcp_powered_agents_cookbook.ipynb_docs.md)
