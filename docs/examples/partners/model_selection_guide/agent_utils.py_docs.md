...
**Functions**: prompt_vars, load_tools, log_json, _parse_json, _dispatch_tool, call_openai

**Dependencies**: Any, OpenAI, Path, __future__, a, annotations, chem_lookup, dataclass, dataclasses, json, openai, pathlib, tools, typing
...
**Same directory**:
- [model_selection_guide.ipynb](./model_selection_guide.ipynb_docs.md)
