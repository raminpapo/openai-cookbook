...
## File Metadata
- **Path**: `examples/partners/model_selection_guide/tools.py`
- **Type**: .py file
- **Size**: 11,148 bytes (10.89 KB)
- **Lines**: 312
- **Words**: 1,086
- **Characters**: 11,135
...
**Functions**: list_available_chemicals, chem_lookup, cost_estimator, outcome_db, literature_search

**Dependencies**: Dict, filter, random, re, typing
...
**Same directory**:
- [agent_utils.py](./agent_utils.py_docs.md)
