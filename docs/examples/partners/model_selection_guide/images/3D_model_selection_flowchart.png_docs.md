# Documentation: 3D_model_selection_flowchart.png

## File Metadata
- **Path**: `examples/partners/model_selection_guide/images/3D_model_selection_flowchart.png`
- **Type**: Binary file
- **Size**: 102,807 bytes (100.40 KB)
- **MIME Type**: image/png
- **Extension**: .png
