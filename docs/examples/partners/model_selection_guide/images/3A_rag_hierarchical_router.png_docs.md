# Documentation: 3A_rag_hierarchical_router.png

## File Metadata
- **Path**: `examples/partners/model_selection_guide/images/3A_rag_hierarchical_router.png`
- **Type**: Binary file
- **Size**: 35,241 bytes (34.42 KB)
- **MIME Type**: image/png
- **Extension**: .png
