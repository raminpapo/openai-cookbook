# Documentation: 3C_insurance_architecture.png

## File Metadata
- **Path**: `examples/partners/model_selection_guide/images/3C_insurance_architecture.png`
- **Type**: Binary file
- **Size**: 139,729 bytes (136.45 KB)
- **MIME Type**: image/png
- **Extension**: .png
