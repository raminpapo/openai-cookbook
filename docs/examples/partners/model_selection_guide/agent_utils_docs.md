# File Documentation: agent_utils.py

## File Metadata
- **Path**: `examples/partners/model_selection_guide/agent_utils.py`
- **Size**: 8,940 bytes (8,934 characters)
- **Lines**: 226
- **Extension**: `.py`
- **Classification**: text
...
This is a Python source file containing 1 class(es) and 5 function(s).
...
- `prompt_vars(self)`
- `load_tools()`
- `log_json(stage: str, data: Any, ctx: Context)`
- `_dispatch_tool(name: str, args: Dict[str, Any])`
- `call_openai(client: OpenAI, model: str, system: str, user: str, ctx: Context)`
...
```bash
# Run this file
python examples/partners/model_selection_guide/agent_utils.py

# Run tests (if this is a test file)
pytest examples/partners/model_selection_guide/agent_utils.py
```

---

*Documentation generated for `examples/partners/model_selection_guide/agent_utils.py`*
