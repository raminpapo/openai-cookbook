...
- **Size**: 11,148 bytes (11,135 characters)
- **Lines**: 312
- **Extension**: `.py`
- **Classification**: text
...
```bash
# Run this file
python examples/partners/model_selection_guide/tools.py

# Run tests (if this is a test file)
pytest examples/partners/model_selection_guide/tools.py
```

---

*Documentation generated for `examples/partners/model_selection_guide/tools.py`*
