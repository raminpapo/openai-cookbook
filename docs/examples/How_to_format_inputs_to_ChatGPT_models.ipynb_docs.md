# Documentation: How_to_format_inputs_to_ChatGPT_models.ipynb
...
File contains 682 lines with structured content.
...
```bash
jupyter notebook How_to_format_inputs_to_ChatGPT_models.ipynb
```
