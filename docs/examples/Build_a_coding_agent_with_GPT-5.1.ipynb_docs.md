# Documentation: Build_a_coding_agent_with_GPT-5.1.ipynb
...
File contains 1804 lines with structured content.
...
```bash
jupyter notebook Build_a_coding_agent_with_GPT-5.1.ipynb
```
