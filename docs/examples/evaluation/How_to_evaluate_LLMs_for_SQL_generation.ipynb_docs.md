# Documentation: How_to_evaluate_LLMs_for_SQL_generation.ipynb

## File Metadata
- **Path**: `examples/evaluation/How_to_evaluate_LLMs_for_SQL_generation.ipynb`
- **Type**: .ipynb file
- **Size**: 106,082 bytes (103.60 KB)
- **Lines**: 1,604
- **Words**: 5,599
- **Characters**: 106,082
...
File contains 1604 lines with structured content.
...
```bash
jupyter notebook How_to_evaluate_LLMs_for_SQL_generation.ipynb
```
...
- [Getting_Started_with_OpenAI_Evals.ipynb](./Getting_Started_with_OpenAI_Evals.ipynb_docs.md)
