# Documentation: Getting_Started_with_OpenAI_Evals.ipynb

## File Metadata
- **Path**: `examples/evaluation/Getting_Started_with_OpenAI_Evals.ipynb`
- **Type**: .ipynb file
- **Size**: 93,403 bytes (91.21 KB)
- **Lines**: 1,266
- **Words**: 7,795
- **Characters**: 92,411
...
File contains 1266 lines with structured content.
...
```bash
jupyter notebook Getting_Started_with_OpenAI_Evals.ipynb
```
...
**Same directory**:
- [Building_resilient_prompts_using_an_evaluation_flywheel.md](./Building_resilient_prompts_using_an_evaluation_flywheel.md_docs.md)
- [Evaluate_RAG_with_LlamaIndex.ipynb](./Evaluate_RAG_with_LlamaIndex.ipynb_docs.md)
- [How_to_eval_abstractive_summarization.ipynb](./How_to_eval_abstractive_summarization.ipynb_docs.md)
- [How_to_evaluate_LLMs_for_SQL_generation.ipynb](./How_to_evaluate_LLMs_for_SQL_generation.ipynb_docs.md)

**Imported modules**:
- `/Users/shyamal/.evals/evals`
- `/Users/shyamal/.evals/modelgraded`
- `/Users/shyamal/.virtualenvs/openai/lib/python3.11/site`
- `194`
- `Europe`
- `IPython.display`
- `OpenAI`
