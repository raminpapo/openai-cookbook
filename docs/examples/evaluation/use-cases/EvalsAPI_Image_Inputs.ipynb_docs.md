# Documentation: EvalsAPI_Image_Inputs.ipynb

## File Metadata
- **Path**: `examples/evaluation/use-cases/EvalsAPI_Image_Inputs.ipynb`
- **Type**: .ipynb file
- **Size**: 24,951 bytes (24.37 KB)
- **Lines**: 562
- **Words**: 2,643
- **Characters**: 24,951
...
File contains 562 lines with structured content.
...
```bash
jupyter notebook EvalsAPI_Image_Inputs.ipynb
```
