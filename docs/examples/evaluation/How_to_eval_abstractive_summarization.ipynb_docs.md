# Documentation: How_to_eval_abstractive_summarization.ipynb
...
File contains 746 lines with structured content.
...
```bash
jupyter notebook How_to_eval_abstractive_summarization.ipynb
```
