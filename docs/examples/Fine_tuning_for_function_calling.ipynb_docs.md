# Documentation: Fine_tuning_for_function_calling.ipynb

## File Metadata
- **Path**: `examples/Fine_tuning_for_function_calling.ipynb`
- **Type**: .ipynb file
- **Size**: 112,111 bytes (109.48 KB)
- **Lines**: 2,453
- **Words**: 9,923
- **Characters**: 112,111
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "<pandas.io.formats.style.Styler at 0x13d068690>"
      ]
     },
     "metadata": {},
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "<pandas.io.formats.style.Styler at 0x13c592190>"
      ]
     },
     "metadata": {},
     "output_type": "display_data"
   ...
   "outputs": [
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       "<pandas.io.formats.style.Styler at 0x13c87a9d0>"
      ]
     },
     "metadata": {},
     "output_type": "display_data"
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       "<pandas.io.formats.style.Styler at 0x13d3c7910>"
      ]
     },
     "metadata": {},
     "output_type": "display_data"
...
File contains 2453 lines with structured content.
...
```bash
jupyter notebook Fine_tuning_for_function_calling.ipynb
```
...
- `display`
- `function`
- `generate_optional_permutations`
- `itertools`
- `json`
- `numpy`
- `one`
