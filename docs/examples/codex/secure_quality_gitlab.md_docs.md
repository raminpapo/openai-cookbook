# Documentation: secure_quality_gitlab.md
...
Markdown documentation file: **Automating Code Quality and Security Fixes with Codex CLI in GitLab**
...
- [jira-github.ipynb](./jira-github.ipynb_docs.md)
