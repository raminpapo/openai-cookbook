# Documentation: jira-github.ipynb

## File Metadata
- **Path**: `examples/codex/jira-github.ipynb`
- **Type**: .ipynb file
- **Size**: 15,148 bytes (14.79 KB)
- **Lines**: 316
- **Words**: 1,663
- **Characters**: 15,102
...
File contains 316 lines with structured content.
...
```bash
jupyter notebook jira-github.ipynb
```
...
**Same directory**:
- [Autofix-github-actions.ipynb](./Autofix-github-actions.ipynb_docs.md)
- [build_code_review_with_codex_sdk.md](./build_code_review_with_codex_sdk.md_docs.md)
- [secure_quality_gitlab.md](./secure_quality_gitlab.md_docs.md)
