# File Documentation: embeddings_utils.py

## File Metadata
- **Path**: `examples/utils/embeddings_utils.py`
- **Size**: 8,172 bytes (8,172 characters)
- **Lines**: 252
- **Extension**: `.py`
- **Classification**: text
...
This is a Python source file and 4 function(s).
...
- `chart_from_components(components: np.ndarray,
    labels: Optional[List[str]] = None,
    strings: Optional[List[str]] = None,
    x_title="Component 0",
    y_title="Component 1",
    mark_size=5,
    **kwargs,)`
- `chart_from_components_3D(components: np.ndarray,
    labels: Optional[List[str]] = None,
    strings: Optional[List[str]] = None,
    x_title: str = "Component 0",
    y_title: str = "Component 1",
...
```bash
# Run this file
python examples/utils/embeddings_utils.py

# Run tests (if this is a test file)
pytest examples/utils/embeddings_utils.py
```

---

*Documentation generated for `examples/utils/embeddings_utils.py`*
