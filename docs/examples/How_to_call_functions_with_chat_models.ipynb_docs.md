# Documentation: How_to_call_functions_with_chat_models.ipynb
...
File contains 895 lines with structured content.
...
```bash
jupyter notebook How_to_call_functions_with_chat_models.ipynb
```
