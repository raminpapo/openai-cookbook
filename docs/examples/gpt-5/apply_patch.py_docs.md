# Documentation: apply_patch.py

## File Metadata
- **Path**: `examples/gpt-5/apply_patch.py`
- **Type**: .py file
- **Size**: 16,625 bytes (16.24 KB)
- **Lines**: 483
- **Words**: 1,528
- **Characters**: 16,625
...
**Classes**: ActionType, FileChange, Commit, Chunk, PatchAction, Patch, Parser, DiffError

**Functions**: assemble_changes, is_done, startswith, read_str, parse, parse_update_file, parse_add_file, find_context_core, find_context, peek_next_section, text_to_patch, identify_files_needed, _get_updated_file, patch_to_commit, load_files, apply_commit, process_patch, open_file, write_file, remove_file ...

**Dependencies**: BaseModel, Callable, Enum, Optional, enum, os, pydantic, sys, typing
...
**Same directory**:
- [gpt-5-1_prompting_guide.ipynb](./gpt-5-1_prompting_guide.ipynb_docs.md)
- [gpt-5_frontend.ipynb](./gpt-5_frontend.ipynb_docs.md)
- [gpt-5_new_params_and_tools.ipynb](./gpt-5_new_params_and_tools.ipynb_docs.md)
- [gpt-5_prompting_guide.ipynb](./gpt-5_prompting_guide.ipynb_docs.md)
- [gpt-5_troubleshooting_guide.ipynb](./gpt-5_troubleshooting_guide.ipynb_docs.md)
- [prompt-optimization-cookbook.ipynb](./prompt-optimization-cookbook.ipynb_docs.md)
