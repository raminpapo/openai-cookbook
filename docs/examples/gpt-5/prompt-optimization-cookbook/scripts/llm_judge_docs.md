...
```bash
# Run this file
python examples/gpt-5/prompt-optimization-cookbook/scripts/llm_judge.py

# Run tests (if this is a test file)
pytest examples/gpt-5/prompt-optimization-cookbook/scripts/llm_judge.py
```

---

*Documentation generated for `examples/gpt-5/prompt-optimization-cookbook/scripts/llm_judge.py`*
