...
**Functions**: _load_system_prompt, _assemble_messages, _to_text, _safe_parse_json, judge_folder, run_one, judge_one, rebuild_summary

**Dependencies**: Dict, OpenAI, Path, ThreadPoolExecutor, a, all, argparse, concurrent.futures, csv, json, openai, pathlib, time, typing
