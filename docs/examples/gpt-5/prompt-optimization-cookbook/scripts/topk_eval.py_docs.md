# Documentation: topk_eval.py

## File Metadata
- **Path**: `examples/gpt-5/prompt-optimization-cookbook/scripts/topk_eval.py`
- **Type**: .py file
- **Size**: 10,949 bytes (10.69 KB)
- **Lines**: 312
- **Words**: 987
- **Characters**: 10,949
...
**Functions**: evaluate_folder, iter_tokens, topk_from_counts, coerce_topk, parse_topk_from_stdout, is_sorted_topk, precision_at_k, scan_constraints

**Dependencies**: Counter, Optional, Path, ast, collections, construction, contextlib, csv, detection, io, json, os, pathlib, random, re ...
