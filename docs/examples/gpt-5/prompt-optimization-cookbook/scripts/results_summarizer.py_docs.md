...
**Functions**: _read_quant_csv, _float, _int, _bool, _read_judge_csv, _num, _avg, summarize_groups, render_charts, vals, print_text_summaries, build_markdown_summary, _fmt, _sign, _add_row

**Dependencies**: Dict, IPython.display, Path, __future__, annotations, argparse, csv, dataclass, dataclasses, display, json, matplotlib.pyplot, pathlib, seaborn, typing
