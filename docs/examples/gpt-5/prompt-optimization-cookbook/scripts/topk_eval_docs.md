...
This is a Python source file and 6 function(s).
...
- `iter_tokens()`
- `topk_from_counts(cnt: Counter, k: int)`
- `coerce_topk(obj)`
- `parse_topk_from_stdout(stdout_str)`
- `is_sorted_topk(pairs)`
...
```bash
# Run this file
python examples/gpt-5/prompt-optimization-cookbook/scripts/topk_eval.py

# Run tests (if this is a test file)
pytest examples/gpt-5/prompt-optimization-cookbook/scripts/topk_eval.py
```

---

*Documentation generated for `examples/gpt-5/prompt-optimization-cookbook/scripts/topk_eval.py`*
