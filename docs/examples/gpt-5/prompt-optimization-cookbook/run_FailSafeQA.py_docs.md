...
CRITERIA: The answer is completely accurate and comprehensive, extending the ground truth with relevant and factual information from the context.
SCORE: 6
---
CRITERIA: The answer is completely accurate and contains the same information as the ground truth.
SCORE: 5
...
**Classes**: AnswerModel, JudgeModel, OpenAIAnswer, OpenAIJudge, class

**Functions**: __call__, __call__, __init__, __call__, __init__, __call__, get_answer_adapter, get_judge_adapter, build_cases, parse_rating, compliance_from_rating, robustness_from_rows, grounding_from_rows, run_failsafeqa, _call_answer_with_retry, _call_judge_with_retry, _run_job, avg, run_failsafeqa_baseline, run_failsafeqa_optimized ...

**Dependencies**: Any, OpenAI, ThreadPoolExecutor, answering, argparse, concurrent.futures, csv, dataclass, dataclasses, datasets, json, load_dataset, logging, math, notebooks ...
