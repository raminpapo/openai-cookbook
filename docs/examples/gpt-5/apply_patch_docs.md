# File Documentation: apply_patch.py

## File Metadata
- **Path**: `examples/gpt-5/apply_patch.py`
- **Size**: 16,625 bytes (16,625 characters)
- **Lines**: 483
- **Extension**: `.py`
- **Classification**: text
...
This is a Python source file containing 8 class(es) and 2 function(s).
...
```bash
# Run this file
python examples/gpt-5/apply_patch.py

# Run tests (if this is a test file)
pytest examples/gpt-5/apply_patch.py
```

---

*Documentation generated for `examples/gpt-5/apply_patch.py`*
