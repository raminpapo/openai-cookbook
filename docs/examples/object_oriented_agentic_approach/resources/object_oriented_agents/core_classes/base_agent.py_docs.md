# Documentation: base_agent.py

## File Metadata
- **Path**: `examples/object_oriented_agentic_approach/resources/object_oriented_agents/core_classes/base_agent.py`
- **Type**: .py file
...
**Functions**: __init__, setup_tools, add_context, add_message, task, signature

**Dependencies**: ..services.language_model_interface, ..utils.logger, .agent_signature, .chat_messages, .tool_manager, ABC, AgentSignature, ChatMessages, LanguageModelInterface, Optional, ToolManager, abc, get_logger, typing
