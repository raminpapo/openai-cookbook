...
**Functions**: __init__, register_tool, get_tool_definitions, handle_tool_call_sequence

**Dependencies**: ..services.language_model_interface, ..utils.logger, .chat_messages, .tool_interface, ChatMessages, Dict, LanguageModelInterface, ToolInterface, get_logger, json, model, the, typing
