# Documentation: python_code_exec_agent.py
...
**Classes**: PythonExecAgent

**Functions**: __init__, setup_tools

**Dependencies**: ...object_oriented_agents.core_classes.base_agent, ...object_oriented_agents.core_classes.tool_manager, ...object_oriented_agents.services.openai_language_model, ...object_oriented_agents.utils.logger, ..tools.python_code_interpreter_tool, BaseAgent, OpenAILanguageModel, PythonExecTool, ToolManager, get_logger, logging, os, the
...
**Same directory**:
- [file_access_agent.py](./file_access_agent.py_docs.md)
