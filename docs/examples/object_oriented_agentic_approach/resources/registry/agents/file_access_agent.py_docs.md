# Documentation: file_access_agent.py
...
**Classes**: FileAccessAgent

**Functions**: __init__, setup_tools

**Dependencies**: ...object_oriented_agents.core_classes.base_agent, ...object_oriented_agents.core_classes.tool_manager, ...object_oriented_agents.services.openai_language_model, ...object_oriented_agents.utils.logger, ..tools.file_access_tool, BaseAgent, FileAccessTool, OpenAILanguageModel, ToolManager, get_logger, logging, os
...
**Same directory**:
- [python_code_exec_agent.py](./python_code_exec_agent.py_docs.md)
