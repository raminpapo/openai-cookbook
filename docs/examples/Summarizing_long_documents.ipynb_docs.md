# Documentation: Summarizing_long_documents.ipynb

## File Metadata
- **Path**: `examples/Summarizing_long_documents.ipynb`
- **Type**: .ipynb file
- **Size**: 75,580 bytes (73.81 KB)
- **Lines**: 862
- **Words**: 9,634
- **Characters**: 75,456
...
File contains 862 lines with structured content.
...
```bash
jupyter notebook Summarizing_long_documents.ipynb
```
