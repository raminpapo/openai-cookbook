# File Documentation: answers_with_ft.py

## File Metadata
- **Path**: `examples/fine-tuned_qa/answers_with_ft.py`
- **Size**: 5,468 bytes (5,468 characters)
- **Lines**: 160
- **Extension**: `.py`
- **Classification**: text
...
- `create_context(question, search_file_id, max_len=1800, search_model="ada", max_rerank=10)`
- `answer_question(search_file_id="<SEARCH_FILE_ID>",
    fine_tuned_qa_model="<FT_QA_MODEL_ID>",
    question="Which country won the European Football championship in 2021?",
    max_len=1800,
    search_model="ada",
...
```bash
# Run this file
python examples/fine-tuned_qa/answers_with_ft.py

# Run tests (if this is a test file)
pytest examples/fine-tuned_qa/answers_with_ft.py
```

---

*Documentation generated for `examples/fine-tuned_qa/answers_with_ft.py`*
