# Documentation: answers_with_ft.py

## File Metadata
- **Path**: `examples/fine-tuned_qa/answers_with_ft.py`
- **Type**: .py file
- **Size**: 5,468 bytes (5.34 KB)
- **Lines**: 160
- **Words**: 472
- **Characters**: 5,468
...
**Functions**: create_context, answer_question

**Dependencies**: OpenAI, argparse, openai, os, the
...
- [reinforcement_finetuning_healthbench.ipynb](./reinforcement_finetuning_healthbench.ipynb_docs.md)
