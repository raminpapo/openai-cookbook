# Documentation: mcp_tool_guide.ipynb

## File Metadata
- **Path**: `examples/mcp/mcp_tool_guide.ipynb`
- **Type**: .ipynb file
- **Size**: 25,942 bytes (25.33 KB)
- **Lines**: 556
- **Words**: 3,177
- **Characters**: 25,847
...
File contains 556 lines with structured content.
...
```bash
jupyter notebook mcp_tool_guide.ipynb
```
...
**Same directory**:
- [databricks_mcp_cookbook.ipynb](./databricks_mcp_cookbook.ipynb_docs.md)
