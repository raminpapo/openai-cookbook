...
- **Size**: 95,983 bytes (95,983 characters)
- **Lines**: 2,806
- **Extension**: `.json`
- **Classification**: text
...
*Documentation generated for `examples/mcp/building-a-supply-chain-copilot-with-agent-sdk-and-databricks-mcp/ui/package-lock.json`*
