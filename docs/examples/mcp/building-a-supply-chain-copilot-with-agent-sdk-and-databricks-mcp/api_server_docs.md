# File Documentation: api_server.py

## File Metadata
- **Path**: `examples/mcp/building-a-supply-chain-copilot-with-agent-sdk-and-databricks-mcp/api_server.py`
- **Size**: 5,048 bytes (5,041 characters)
- **Lines**: 139
- **Extension**: `.py`
- **Classification**: text
...
```bash
# Run this file
python examples/mcp/building-a-supply-chain-copilot-with-agent-sdk-and-databricks-mcp/api_server.py

# Run tests (if this is a test file)
pytest examples/mcp/building-a-supply-chain-copilot-with-agent-sdk-and-databricks-mcp/api_server.py
```

---

*Documentation generated for `examples/mcp/building-a-supply-chain-copilot-with-agent-sdk-and-databricks-mcp/api_server.py`*
