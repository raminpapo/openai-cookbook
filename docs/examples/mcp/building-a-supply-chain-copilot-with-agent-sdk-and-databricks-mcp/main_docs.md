...
- **Size**: 3,656 bytes (3,656 characters)
- **Lines**: 90
- **Extension**: `.py`
- **Classification**: text
...
```bash
# Run this file
python examples/mcp/building-a-supply-chain-copilot-with-agent-sdk-and-databricks-mcp/main.py

# Run tests (if this is a test file)
pytest examples/mcp/building-a-supply-chain-copilot-with-agent-sdk-and-databricks-mcp/main.py
```

---

*Documentation generated for `examples/mcp/building-a-supply-chain-copilot-with-agent-sdk-and-databricks-mcp/main.py`*
