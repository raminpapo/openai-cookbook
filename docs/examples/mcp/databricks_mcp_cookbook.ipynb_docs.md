# Documentation: databricks_mcp_cookbook.ipynb
...
File contains 844 lines with structured content.
...
```bash
jupyter notebook databricks_mcp_cookbook.ipynb
```
...
**Same directory**:
- [mcp_tool_guide.ipynb](./mcp_tool_guide.ipynb_docs.md)
