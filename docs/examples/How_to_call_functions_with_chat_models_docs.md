# File Documentation: How_to_call_functions_with_chat_models.ipynb

## File Metadata
- **Path**: `examples/How_to_call_functions_with_chat_models.ipynb`
- **Size**: 32,221 bytes (32,221 characters)
- **Lines**: 895
- **Extension**: `.ipynb`
- **Classification**: text
...
*Documentation generated for `examples/How_to_call_functions_with_chat_models.ipynb`*
