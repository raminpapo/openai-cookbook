# Documentation: Image_generations_edits_and_variations_with_DALL-E.ipynb

## File Metadata
- **Path**: `examples/dalle/Image_generations_edits_and_variations_with_DALL-E.ipynb`
- **Type**: .ipynb file
- **Size**: 16,205 bytes (15.83 KB)
- **Lines**: 385
- **Words**: 1,658
- **Characters**: 16,201
...
File contains 385 lines with structured content.
...
**Same directory**:
- [How_to_create_dynamic_masks_with_DALL-E_and_Segment_Anything.ipynb](./How_to_create_dynamic_masks_with_DALL-E_and_Segment_Anything.ipynb_docs.md)
