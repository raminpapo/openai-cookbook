# Documentation: User_and_product_embeddings.ipynb

## File Metadata
- **Path**: `examples/User_and_product_embeddings.ipynb`
- **Type**: .ipynb file
- **Size**: 28,869 bytes (28.19 KB)
- **Lines**: 274
- **Words**: 963
- **Characters**: 28,869
...
File contains 274 lines with structured content.
...
```bash
jupyter notebook User_and_product_embeddings.ipynb
```
