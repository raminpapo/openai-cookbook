# Documentation: Visualizing_embeddings_in_Kangas.ipynb

## File Metadata
- **Path**: `examples/third_party/Visualizing_embeddings_in_Kangas.ipynb`
- **Type**: .ipynb file
- **Size**: 20,905 bytes (20.42 KB)
- **Lines**: 440
- **Words**: 2,329
- **Characters**: 20,569
...
File contains 440 lines with structured content.
...
```bash
jupyter notebook Visualizing_embeddings_in_Kangas.ipynb
```
