# File Documentation: Code_quality_and_security_scan_with_GitHub_Actions.md

## File Metadata
- **Path**: `examples/third_party/Code_quality_and_security_scan_with_GitHub_Actions.md`
- **Size**: 10,897 bytes (10,859 characters)
- **Lines**: 260
- **Extension**: `.md`
- **Classification**: text
...
*Documentation generated for `examples/third_party/Code_quality_and_security_scan_with_GitHub_Actions.md`*
