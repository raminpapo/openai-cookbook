# Documentation: custom_image_embedding_search.ipynb

## File Metadata
- **Path**: `examples/custom_image_embedding_search.ipynb`
- **Type**: .ipynb file
- **Size**: 19,413 bytes (18.96 KB)
- **Lines**: 613
- **Words**: 2,093
- **Characters**: 19,413
...
File contains 613 lines with structured content.
...
```bash
jupyter notebook custom_image_embedding_search.ipynb
```
