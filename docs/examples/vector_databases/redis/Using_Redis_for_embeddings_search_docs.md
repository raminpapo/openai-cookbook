# File Documentation: Using_Redis_for_embeddings_search.ipynb

## File Metadata
- **Path**: `examples/vector_databases/redis/Using_Redis_for_embeddings_search.ipynb`
- **Size**: 31,194 bytes (31,194 characters)
- **Lines**: 800
- **Extension**: `.ipynb`
- **Classification**: text
...
*Documentation generated for `examples/vector_databases/redis/Using_Redis_for_embeddings_search.ipynb`*
