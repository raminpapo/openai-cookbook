# Documentation: Using_Redis_for_embeddings_search.ipynb

## File Metadata
- **Path**: `examples/vector_databases/redis/Using_Redis_for_embeddings_search.ipynb`
- **Type**: .ipynb file
- **Size**: 31,194 bytes (30.46 KB)
- **Lines**: 800
- **Words**: 3,230
- **Characters**: 31,194
...
File contains 800 lines with structured content.
...
```bash
jupyter notebook Using_Redis_for_embeddings_search.ipynb
```
