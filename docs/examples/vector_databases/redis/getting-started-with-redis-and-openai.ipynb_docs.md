# Documentation: getting-started-with-redis-and-openai.ipynb
...
File contains 878 lines with structured content.
...
```bash
jupyter notebook getting-started-with-redis-and-openai.ipynb
```
