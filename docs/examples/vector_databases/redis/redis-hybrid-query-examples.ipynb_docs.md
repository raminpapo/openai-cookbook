# Documentation: redis-hybrid-query-examples.ipynb

## File Metadata
- **Path**: `examples/vector_databases/redis/redis-hybrid-query-examples.ipynb`
- **Type**: .ipynb file
- **Size**: 34,964 bytes (34.14 KB)
- **Lines**: 915
- **Words**: 3,570
- **Characters**: 34,964
...
File contains 915 lines with structured content.
...
```bash
jupyter notebook redis-hybrid-query-examples.ipynb
```
