# File Documentation: semantic_search_using_mongodb_atlas_vector_search.ipynb

## File Metadata
- **Path**: `examples/vector_databases/mongodb_atlas/semantic_search_using_mongodb_atlas_vector_search.ipynb`
- **Size**: 17,471 bytes (16,951 characters)
- **Lines**: 405
- **Extension**: `.ipynb`
- **Classification**: text
...
*Documentation generated for `examples/vector_databases/mongodb_atlas/semantic_search_using_mongodb_atlas_vector_search.ipynb`*
