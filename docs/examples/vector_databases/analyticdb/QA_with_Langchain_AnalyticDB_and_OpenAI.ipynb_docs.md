...
```bash
jupyter notebook QA_with_Langchain_AnalyticDB_and_OpenAI.ipynb
```
...
**Same directory**:
- [Getting_started_with_AnalyticDB_and_OpenAI.ipynb](./Getting_started_with_AnalyticDB_and_OpenAI.ipynb_docs.md)
