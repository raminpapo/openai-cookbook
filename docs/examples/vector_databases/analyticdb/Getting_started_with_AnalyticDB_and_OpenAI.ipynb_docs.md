...
File contains 590 lines with structured content.
...
```bash
jupyter notebook Getting_started_with_AnalyticDB_and_OpenAI.ipynb
```
...
**Same directory**:
- [QA_with_Langchain_AnalyticDB_and_OpenAI.ipynb](./QA_with_Langchain_AnalyticDB_and_OpenAI.ipynb_docs.md)
