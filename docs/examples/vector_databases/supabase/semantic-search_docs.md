# File Documentation: semantic-search.mdx

## File Metadata
- **Path**: `examples/vector_databases/supabase/semantic-search.mdx`
- **Size**: 12,702 bytes (12,702 characters)
- **Lines**: 277
- **Extension**: `.mdx`
- **Classification**: text
...
*Documentation generated for `examples/vector_databases/supabase/semantic-search.mdx`*
