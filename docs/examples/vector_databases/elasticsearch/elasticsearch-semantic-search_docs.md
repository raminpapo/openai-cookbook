# File Documentation: elasticsearch-semantic-search.ipynb

## File Metadata
- **Path**: `examples/vector_databases/elasticsearch/elasticsearch-semantic-search.ipynb`
- **Size**: 132,678 bytes (132,547 characters)
- **Lines**: 813
- **Extension**: `.ipynb`
- **Classification**: text
...
*Documentation generated for `examples/vector_databases/elasticsearch/elasticsearch-semantic-search.ipynb`*
