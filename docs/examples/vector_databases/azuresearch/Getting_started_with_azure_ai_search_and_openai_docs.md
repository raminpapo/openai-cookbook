# File Documentation: Getting_started_with_azure_ai_search_and_openai.ipynb

## File Metadata
- **Path**: `examples/vector_databases/azuresearch/Getting_started_with_azure_ai_search_and_openai.ipynb`
- **Size**: 37,240 bytes (37,236 characters)
- **Lines**: 739
- **Extension**: `.ipynb`
- **Classification**: text
...
*Documentation generated for `examples/vector_databases/azuresearch/Getting_started_with_azure_ai_search_and_openai.ipynb`*
