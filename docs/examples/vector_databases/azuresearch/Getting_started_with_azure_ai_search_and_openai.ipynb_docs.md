# Documentation: Getting_started_with_azure_ai_search_and_openai.ipynb
...
File contains 739 lines with structured content.
...
```bash
jupyter notebook Getting_started_with_azure_ai_search_and_openai.ipynb
```
