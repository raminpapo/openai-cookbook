# Documentation: question-answering-with-weaviate-and-openai.ipynb

## File Metadata
- **Path**: `examples/vector_databases/weaviate/question-answering-with-weaviate-and-openai.ipynb`
- **Type**: .ipynb file
- **Size**: 21,851 bytes (21.34 KB)
- **Lines**: 584
- **Words**: 2,423
- **Characters**: 21,831
...
File contains 584 lines with structured content.
...
```bash
jupyter notebook question-answering-with-weaviate-and-openai.ipynb
```
