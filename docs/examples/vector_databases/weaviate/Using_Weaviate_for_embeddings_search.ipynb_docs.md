# Documentation: Using_Weaviate_for_embeddings_search.ipynb

## File Metadata
- **Path**: `examples/vector_databases/weaviate/Using_Weaviate_for_embeddings_search.ipynb`
- **Type**: .ipynb file
- **Size**: 42,050 bytes (41.06 KB)
- **Lines**: 1,174
- **Words**: 4,696
- **Characters**: 42,048
...
File contains 1174 lines with structured content.
...
```bash
jupyter notebook Using_Weaviate_for_embeddings_search.ipynb
```
