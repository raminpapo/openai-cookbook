# Documentation: hybrid-search-with-weaviate-and-openai.ipynb

## File Metadata
- **Path**: `examples/vector_databases/weaviate/hybrid-search-with-weaviate-and-openai.ipynb`
- **Type**: .ipynb file
- **Size**: 21,331 bytes (20.83 KB)
- **Lines**: 576
- **Words**: 2,402
- **Characters**: 21,311
...
File contains 576 lines with structured content.
...
```bash
jupyter notebook hybrid-search-with-weaviate-and-openai.ipynb
```
