# Documentation: getting-started-with-weaviate-and-openai.ipynb

## File Metadata
- **Path**: `examples/vector_databases/weaviate/getting-started-with-weaviate-and-openai.ipynb`
- **Type**: .ipynb file
- **Size**: 21,085 bytes (20.59 KB)
- **Lines**: 574
- **Words**: 2,385
- **Characters**: 21,065
...
File contains 574 lines with structured content.
...
```bash
jupyter notebook getting-started-with-weaviate-and-openai.ipynb
```
