# Documentation: Getting_started_with_Qdrant_and_OpenAI.ipynb

## File Metadata
- **Path**: `examples/vector_databases/qdrant/Getting_started_with_Qdrant_and_OpenAI.ipynb`
- **Type**: .ipynb file
- **Size**: 23,269 bytes (22.72 KB)
- **Lines**: 728
- **Words**: 2,280
- **Characters**: 23,267
...
File contains 728 lines with structured content.
...
```bash
jupyter notebook Getting_started_with_Qdrant_and_OpenAI.ipynb
```
...
- [docker-compose.yaml](./docker-compose.yaml_docs.md)
