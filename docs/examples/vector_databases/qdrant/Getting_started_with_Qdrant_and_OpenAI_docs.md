# File Documentation: Getting_started_with_Qdrant_and_OpenAI.ipynb

## File Metadata
- **Path**: `examples/vector_databases/qdrant/Getting_started_with_Qdrant_and_OpenAI.ipynb`
- **Size**: 23,269 bytes (23,267 characters)
- **Lines**: 728
- **Extension**: `.ipynb`
- **Classification**: text
...
*Documentation generated for `examples/vector_databases/qdrant/Getting_started_with_Qdrant_and_OpenAI.ipynb`*
