# Documentation: Using_Qdrant_for_embeddings_search.ipynb
...
File contains 791 lines with structured content.
...
```bash
jupyter notebook Using_Qdrant_for_embeddings_search.ipynb
```
