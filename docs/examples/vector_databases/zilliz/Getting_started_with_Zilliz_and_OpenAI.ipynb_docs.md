# Documentation: Getting_started_with_Zilliz_and_OpenAI.ipynb
...
File contains 423 lines with structured content.
...
```bash
jupyter notebook Getting_started_with_Zilliz_and_OpenAI.ipynb
```
...
**Same directory**:
- [Filtered_search_with_Zilliz_and_OpenAI.ipynb](./Filtered_search_with_Zilliz_and_OpenAI.ipynb_docs.md)
