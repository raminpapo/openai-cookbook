# Documentation: Filtered_search_with_Zilliz_and_OpenAI.ipynb

## File Metadata
- **Path**: `examples/vector_databases/zilliz/Filtered_search_with_Zilliz_and_OpenAI.ipynb`
- **Type**: .ipynb file
- **Size**: 12,034 bytes (11.75 KB)
- **Lines**: 328
- **Words**: 1,345
- **Characters**: 12,014
...
File contains 328 lines with structured content.
...
```bash
jupyter notebook Filtered_search_with_Zilliz_and_OpenAI.ipynb
```
...
**Same directory**:
- [Getting_started_with_Zilliz_and_OpenAI.ipynb](./Getting_started_with_Zilliz_and_OpenAI.ipynb_docs.md)
