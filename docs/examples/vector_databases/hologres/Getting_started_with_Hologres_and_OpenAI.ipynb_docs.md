# Documentation: Getting_started_with_Hologres_and_OpenAI.ipynb
...
File contains 867 lines with structured content.
...
```bash
jupyter notebook Getting_started_with_Hologres_and_OpenAI.ipynb
```
