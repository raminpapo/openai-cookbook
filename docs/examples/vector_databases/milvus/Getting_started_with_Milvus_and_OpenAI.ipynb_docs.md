# Documentation: Getting_started_with_Milvus_and_OpenAI.ipynb

## File Metadata
- **Path**: `examples/vector_databases/milvus/Getting_started_with_Milvus_and_OpenAI.ipynb`
- **Type**: .ipynb file
- **Size**: 65,739 bytes (64.20 KB)
- **Lines**: 576
- **Words**: 3,524
- **Characters**: 65,503
...
```bash
jupyter notebook Getting_started_with_Milvus_and_OpenAI.ipynb
```
...
**Same directory**:
- [Filtered_search_with_Milvus_and_OpenAI.ipynb](./Filtered_search_with_Milvus_and_OpenAI.ipynb_docs.md)
