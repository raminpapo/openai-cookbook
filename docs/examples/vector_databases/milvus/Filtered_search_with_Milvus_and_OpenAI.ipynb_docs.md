# Documentation: Filtered_search_with_Milvus_and_OpenAI.ipynb

## File Metadata
- **Path**: `examples/vector_databases/milvus/Filtered_search_with_Milvus_and_OpenAI.ipynb`
- **Type**: .ipynb file
- **Size**: 22,099 bytes (21.58 KB)
- **Lines**: 445
- **Words**: 1,896
- **Characters**: 21,939
...
File contains 445 lines with structured content.
...
```bash
jupyter notebook Filtered_search_with_Milvus_and_OpenAI.ipynb
```
...
**Same directory**:
- [Getting_started_with_Milvus_and_OpenAI.ipynb](./Getting_started_with_Milvus_and_OpenAI.ipynb_docs.md)
