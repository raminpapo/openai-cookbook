# File Documentation: neon-postgres-vector-search-pgvector.ipynb

## File Metadata
- **Path**: `examples/vector_databases/neon/neon-postgres-vector-search-pgvector.ipynb`
- **Size**: 17,841 bytes (17,841 characters)
- **Lines**: 548
- **Extension**: `.ipynb`
- **Classification**: text
...
*Documentation generated for `examples/vector_databases/neon/neon-postgres-vector-search-pgvector.ipynb`*
