# Documentation: neon-postgres-vector-search-pgvector.ipynb

## File Metadata
- **Path**: `examples/vector_databases/neon/neon-postgres-vector-search-pgvector.ipynb`
- **Type**: .ipynb file
- **Size**: 17,841 bytes (17.42 KB)
- **Lines**: 548
- **Words**: 1,987
- **Characters**: 17,841
...
File contains 548 lines with structured content.
...
```bash
jupyter notebook neon-postgres-vector-search-pgvector.ipynb
```
