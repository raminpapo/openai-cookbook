...
Markdown documentation file: **Kusto as a Vector database**
...
**Same directory**:
- [Getting_started_with_kusto_and_openai_embeddings.ipynb](./Getting_started_with_kusto_and_openai_embeddings.ipynb_docs.md)
