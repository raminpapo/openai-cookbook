# Documentation: hyde-with-chroma-and-openai.ipynb

## File Metadata
- **Path**: `examples/vector_databases/chroma/hyde-with-chroma-and-openai.ipynb`
- **Type**: .ipynb file
- **Size**: 37,515 bytes (36.64 KB)
- **Lines**: 995
- **Words**: 4,295
- **Characters**: 37,515
...
```bash
jupyter notebook hyde-with-chroma-and-openai.ipynb
```
...
**Same directory**:
- [Using_Chroma_for_embeddings_search.ipynb](./Using_Chroma_for_embeddings_search.ipynb_docs.md)
