# Documentation: Using_Chroma_for_embeddings_search.ipynb
...
File contains 896 lines with structured content.
...
```bash
jupyter notebook Using_Chroma_for_embeddings_search.ipynb
```
...
**Same directory**:
- [hyde-with-chroma-and-openai.ipynb](./hyde-with-chroma-and-openai.ipynb_docs.md)
