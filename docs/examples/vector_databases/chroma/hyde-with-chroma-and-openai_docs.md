# File Documentation: hyde-with-chroma-and-openai.ipynb

## File Metadata
- **Path**: `examples/vector_databases/chroma/hyde-with-chroma-and-openai.ipynb`
- **Size**: 37,515 bytes (37,515 characters)
- **Lines**: 995
- **Extension**: `.ipynb`
- **Classification**: text
...
*Documentation generated for `examples/vector_databases/chroma/hyde-with-chroma-and-openai.ipynb`*
