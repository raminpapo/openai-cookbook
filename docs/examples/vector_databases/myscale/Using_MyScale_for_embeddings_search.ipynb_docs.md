# Documentation: Using_MyScale_for_embeddings_search.ipynb

## File Metadata
- **Path**: `examples/vector_databases/myscale/Using_MyScale_for_embeddings_search.ipynb`
- **Type**: .ipynb file
- **Size**: 18,640 bytes (18.20 KB)
- **Lines**: 532
- **Words**: 1,944
- **Characters**: 18,640
...
File contains 532 lines with structured content.
...
```bash
jupyter notebook Using_MyScale_for_embeddings_search.ipynb
```
...
**Same directory**:
- [Getting_started_with_MyScale_and_OpenAI.ipynb](./Getting_started_with_MyScale_and_OpenAI.ipynb_docs.md)
