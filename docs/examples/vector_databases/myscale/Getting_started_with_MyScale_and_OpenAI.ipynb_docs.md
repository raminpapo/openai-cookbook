# Documentation: Getting_started_with_MyScale_and_OpenAI.ipynb

## File Metadata
- **Path**: `examples/vector_databases/myscale/Getting_started_with_MyScale_and_OpenAI.ipynb`
- **Type**: .ipynb file
- **Size**: 11,097 bytes (10.84 KB)
- **Lines**: 379
- **Words**: 1,187
- **Characters**: 11,097
...
File contains 379 lines with structured content.
...
```bash
jupyter notebook Getting_started_with_MyScale_and_OpenAI.ipynb
```
...
**Same directory**:
- [Using_MyScale_for_embeddings_search.ipynb](./Using_MyScale_for_embeddings_search.ipynb_docs.md)
