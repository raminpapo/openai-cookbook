# File Documentation: gpt_action_snowflake_direct.ipynb

## File Metadata
- **Path**: `examples/chatgpt/gpt_actions_library/gpt_action_snowflake_direct.ipynb`
- **Size**: 20,569 bytes (20,557 characters)
- **Lines**: 554
- **Extension**: `.ipynb`
- **Classification**: text
...
*Documentation generated for `examples/chatgpt/gpt_actions_library/gpt_action_snowflake_direct.ipynb`*
