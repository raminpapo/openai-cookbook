# File Documentation: gpt_action_canvas.md

## File Metadata
- **Path**: `examples/chatgpt/gpt_actions_library/gpt_action_canvas.md`
- **Size**: 27,670 bytes (27,659 characters)
- **Lines**: 594
- **Extension**: `.md`
- **Classification**: text
...
*Documentation generated for `examples/chatgpt/gpt_actions_library/gpt_action_canvas.md`*
