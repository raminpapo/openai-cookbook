# File Documentation: gpt_action_jira.ipynb

## File Metadata
- **Path**: `examples/chatgpt/gpt_actions_library/gpt_action_jira.ipynb`
- **Size**: 18,807 bytes (18,801 characters)
- **Lines**: 577
- **Extension**: `.ipynb`
- **Classification**: text
...
*Documentation generated for `examples/chatgpt/gpt_actions_library/gpt_action_jira.ipynb`*
