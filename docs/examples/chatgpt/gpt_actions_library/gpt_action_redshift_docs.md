# File Documentation: gpt_action_redshift.ipynb

## File Metadata
- **Path**: `examples/chatgpt/gpt_actions_library/gpt_action_redshift.ipynb`
- **Size**: 21,996 bytes (21,996 characters)
- **Lines**: 596
- **Extension**: `.ipynb`
- **Classification**: text
...
*Documentation generated for `examples/chatgpt/gpt_actions_library/gpt_action_redshift.ipynb`*
