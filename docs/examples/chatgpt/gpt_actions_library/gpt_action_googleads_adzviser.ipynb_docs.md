...
File contains 662 lines with structured content.
...
```bash
jupyter notebook gpt_action_googleads_adzviser.ipynb
```
...
- [gpt_action_jira.ipynb](./gpt_action_jira.ipynb_docs.md)
