# File Documentation: gpt_action_salesforce.ipynb

## File Metadata
- **Path**: `examples/chatgpt/gpt_actions_library/gpt_action_salesforce.ipynb`
- **Size**: 15,888 bytes (15,850 characters)
- **Lines**: 501
- **Extension**: `.ipynb`
- **Classification**: text
...
*Documentation generated for `examples/chatgpt/gpt_actions_library/gpt_action_salesforce.ipynb`*
