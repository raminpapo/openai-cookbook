# File Documentation: gpt_action_github.md

## File Metadata
- **Path**: `examples/chatgpt/gpt_actions_library/gpt_action_github.md`
- **Size**: 9,660 bytes (9,656 characters)
- **Lines**: 215
- **Extension**: `.md`
- **Classification**: text
...
*Documentation generated for `examples/chatgpt/gpt_actions_library/gpt_action_github.md`*
