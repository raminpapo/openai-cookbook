# File Documentation: function_app.py

## File Metadata
- **Path**: `examples/chatgpt/rag-quickstart/azure/function_app.py`
- **Size**: 6,176 bytes (6,023 characters)
- **Lines**: 154
- **Extension**: `.py`
- **Classification**: text
...
```bash
# Run this file
python examples/chatgpt/rag-quickstart/azure/function_app.py

# Run tests (if this is a test file)
pytest examples/chatgpt/rag-quickstart/azure/function_app.py
```

---

*Documentation generated for `examples/chatgpt/rag-quickstart/azure/function_app.py`*
