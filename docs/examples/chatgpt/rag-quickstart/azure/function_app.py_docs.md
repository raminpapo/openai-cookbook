# Documentation: function_app.py

## File Metadata
- **Path**: `examples/chatgpt/rag-quickstart/azure/function_app.py`
- **Type**: .py file
...
**Functions**: generate_embeddings, vector_similarity_search

**Dependencies**: AzureKeyCredential, OpenAI, SearchClient, SearchIndexClient, azure.core.credentials, azure.functions, azure.search.documents, azure.search.documents.indexes, azure.search.documents.models, json, logging, openai, os, results, the
