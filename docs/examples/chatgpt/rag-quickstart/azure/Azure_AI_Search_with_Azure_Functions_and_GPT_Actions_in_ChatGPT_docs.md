# File Documentation: Azure_AI_Search_with_Azure_Functions_and_GPT_Actions_in_ChatGPT.ipynb

## File Metadata
- **Path**: `examples/chatgpt/rag-quickstart/azure/Azure_AI_Search_with_Azure_Functions_and_GPT_Actions_in_ChatGPT.ipynb`
- **Size**: 65,791 bytes (65,791 characters)
- **Lines**: 1,215
- **Extension**: `.ipynb`
- **Classification**: text
...
*Documentation generated for `examples/chatgpt/rag-quickstart/azure/Azure_AI_Search_with_Azure_Functions_and_GPT_Actions_in_ChatGPT.ipynb`*
