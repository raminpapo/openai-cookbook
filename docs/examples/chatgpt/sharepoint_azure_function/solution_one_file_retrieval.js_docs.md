# Documentation: solution_one_file_retrieval.js

## File Metadata
- **Path**: `examples/chatgpt/sharepoint_azure_function/solution_one_file_retrieval.js`
- **Type**: .js file
...
**Functions**: initGraphClient, getOboToken, getDriveItemContent, defined, processList
...
```javascript
import { ... } from './solution_one_file_retrieval.js';
```
...
- [solution_two_preprocessing.js](./solution_two_preprocessing.js_docs.md)
