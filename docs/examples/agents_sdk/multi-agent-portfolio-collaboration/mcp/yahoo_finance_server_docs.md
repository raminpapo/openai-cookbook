# File Documentation: yahoo_finance_server.py

## File Metadata
- **Path**: `examples/agents_sdk/multi-agent-portfolio-collaboration/mcp/yahoo_finance_server.py`
- **Size**: 25,130 bytes (25,130 characters)
- **Lines**: 486
- **Extension**: `.py`
- **Classification**: text
...
This is a Python source file containing 3 class(es) and 11 function(s).
...
- `save_df_to_csv(df, base_name)`
- `save_json_to_file(data, base_name)`
- `get_historical_stock_prices_sync(ticker, period, interval)`
- `get_stock_info_sync(ticker)`
- `get_yahoo_finance_news_sync(ticker)`
- `get_stock_actions_sync(ticker)`
- `get_financial_statement_sync(ticker, financial_type)`
- `get_holder_info_sync(ticker, holder_type)`
- `get_option_expiration_dates_sync(ticker)`
- `get_option_chain_sync(ticker, expiration_date, option_type)`
- `get_recommendations_sync(ticker, recommendation_type, months_back=12)`
...
```bash
# Run this file
python examples/agents_sdk/multi-agent-portfolio-collaboration/mcp/yahoo_finance_server.py

# Run tests (if this is a test file)
pytest examples/agents_sdk/multi-agent-portfolio-collaboration/mcp/yahoo_finance_server.py
```

---

*Documentation generated for `examples/agents_sdk/multi-agent-portfolio-collaboration/mcp/yahoo_finance_server.py`*
