...
- **Size**: 11,927 bytes (11,927 characters)
- **Lines**: 286
- **Extension**: `.py`
- **Classification**: text
...
- `code_interpreter_error_handler(ctx, error)`
...
```bash
# Run this file
python examples/agents_sdk/multi-agent-portfolio-collaboration/tools.py

# Run tests (if this is a test file)
pytest examples/agents_sdk/multi-agent-portfolio-collaboration/tools.py
```

---

*Documentation generated for `examples/agents_sdk/multi-agent-portfolio-collaboration/tools.py`*
