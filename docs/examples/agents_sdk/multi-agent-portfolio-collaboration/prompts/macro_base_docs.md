# File Documentation: macro_base.md

## File Metadata
- **Path**: `examples/agents_sdk/multi-agent-portfolio-collaboration/prompts/macro_base.md`
- **Size**: 3,107 bytes (3,087 characters)
- **Lines**: 66
- **Extension**: `.md`
- **Classification**: text
...
*Documentation generated for `examples/agents_sdk/multi-agent-portfolio-collaboration/prompts/macro_base.md`*
