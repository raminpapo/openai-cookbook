# Documentation: quant_base.md

## File Metadata
- **Path**: `examples/agents_sdk/multi-agent-portfolio-collaboration/prompts/quant_base.md`
- **Type**: .md file
- **Size**: 6,168 bytes (6.02 KB)
- **Lines**: 85
- **Words**: 959
- **Characters**: 6,150
...
Markdown documentation file: **Quantitative Researcher – Prompt**
