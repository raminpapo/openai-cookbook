# Documentation: editor_base.md

## File Metadata
- **Path**: `examples/agents_sdk/multi-agent-portfolio-collaboration/prompts/editor_base.md`
- **Type**: .md file
- **Size**: 6,628 bytes (6.47 KB)
- **Lines**: 107
- **Words**: 951
- **Characters**: 6,624
...
Markdown documentation file: **Memo Editor – Prompt**
