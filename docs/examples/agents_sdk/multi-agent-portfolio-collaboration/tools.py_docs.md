...
**Functions**: code_interpreter_error_handler, run_code_interpreter, write_markdown, read_file, get_fred_series, list_output_files

**Dependencies**: Fred, OpenAI, Path, agents, fredapi, function_tool, json, openai, os, outputs_dir, pandas, pathlib, re, requests, the ...
