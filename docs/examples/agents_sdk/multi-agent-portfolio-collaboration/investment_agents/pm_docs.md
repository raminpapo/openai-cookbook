...
- `build_head_pm_agent(fundamental, macro, quant, memo_edit_tool)`
- `make_agent_tool(agent, name, description)`
...
```bash
# Run this file
python examples/agents_sdk/multi-agent-portfolio-collaboration/investment_agents/pm.py

# Run tests (if this is a test file)
pytest examples/agents_sdk/multi-agent-portfolio-collaboration/investment_agents/pm.py
```

---

*Documentation generated for `examples/agents_sdk/multi-agent-portfolio-collaboration/investment_agents/pm.py`*
