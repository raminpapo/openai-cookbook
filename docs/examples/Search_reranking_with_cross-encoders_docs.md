# File Documentation: Search_reranking_with_cross-encoders.ipynb

## File Metadata
- **Path**: `examples/Search_reranking_with_cross-encoders.ipynb`
- **Size**: 52,682 bytes (52,657 characters)
- **Lines**: 818
- **Extension**: `.ipynb`
- **Classification**: text
...
*Documentation generated for `examples/Search_reranking_with_cross-encoders.ipynb`*
