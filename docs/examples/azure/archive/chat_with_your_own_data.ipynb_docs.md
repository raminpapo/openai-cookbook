# Documentation: chat_with_your_own_data.ipynb

## File Metadata
- **Path**: `examples/azure/archive/chat_with_your_own_data.ipynb`
- **Type**: .ipynb file
- **Size**: 46,646 bytes (45.55 KB)
- **Lines**: 449
- **Words**: 4,534
- **Characters**: 46,646
...
File contains 449 lines with structured content.
...
```bash
jupyter notebook chat_with_your_own_data.ipynb
```
...
**Same directory**:
- [DALL-E.ipynb](./DALL-E.ipynb_docs.md)
- [chat.ipynb](./chat.ipynb_docs.md)
- [completions.ipynb](./completions.ipynb_docs.md)
- [embeddings.ipynb](./embeddings.ipynb_docs.md)
- [functions.ipynb](./functions.ipynb_docs.md)
- [whisper.ipynb](./whisper.ipynb_docs.md)
