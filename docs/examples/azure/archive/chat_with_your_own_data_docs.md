# File Documentation: chat_with_your_own_data.ipynb

## File Metadata
- **Path**: `examples/azure/archive/chat_with_your_own_data.ipynb`
- **Size**: 46,646 bytes (46,646 characters)
- **Lines**: 449
- **Extension**: `.ipynb`
- **Classification**: text
...
*Documentation generated for `examples/azure/archive/chat_with_your_own_data.ipynb`*
