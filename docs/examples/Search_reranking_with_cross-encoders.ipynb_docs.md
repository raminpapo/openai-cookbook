# Documentation: Search_reranking_with_cross-encoders.ipynb
...
File contains 818 lines with structured content.
...
```bash
jupyter notebook Search_reranking_with_cross-encoders.ipynb
```
