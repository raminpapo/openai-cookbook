# File Documentation: repo_book_gen.py

## File Metadata
- **Path**: `repo_book_gen.py`
- **Size**: 6,286 bytes (6,286 characters)
- **Lines**: 187
- **Extension**: `.py`
- **Classification**: text
...
This is a Python source file containing 1 class(es) and 8 function(s).
...
- `__init__(self, repo_path=".", output_dir="./docs")`
- `compute_repo_fingerprint(self)`
...
pytest repo_book_gen.py
```

---

*Documentation generated for `repo_book_gen.py`*
