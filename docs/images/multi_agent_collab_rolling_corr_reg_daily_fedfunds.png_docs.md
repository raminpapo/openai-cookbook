# Documentation: multi_agent_collab_rolling_corr_reg_daily_fedfunds.png

## File Metadata
- **Path**: `images/multi_agent_collab_rolling_corr_reg_daily_fedfunds.png`
- **Type**: Binary file
- **Size**: 180,013 bytes (175.79 KB)
- **MIME Type**: image/png
- **Extension**: .png
