# Documentation: multi_agent_collab_rolling_volatility_comparison.png

## File Metadata
- **Path**: `images/multi_agent_collab_rolling_volatility_comparison.png`
- **Type**: Binary file
- **Size**: 172,412 bytes (168.37 KB)
- **MIME Type**: image/png
- **Extension**: .png
