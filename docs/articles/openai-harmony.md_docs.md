# Documentation: openai-harmony.md

## File Metadata
- **Path**: `articles/openai-harmony.md`
- **Type**: .md file
- **Size**: 29,299 bytes (28.61 KB)
- **Lines**: 580
- **Words**: 3,589
- **Characters**: 29,189
...
Markdown documentation file: **OpenAI harmony response format**
...
**Same directory**:
- [codex_exec_plans.md](./codex_exec_plans.md_docs.md)
