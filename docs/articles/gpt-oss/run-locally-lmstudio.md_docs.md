# Documentation: run-locally-lmstudio.md

## File Metadata
- **Path**: `articles/gpt-oss/run-locally-lmstudio.md`
- **Type**: .md file
- **Size**: 7,220 bytes (7.05 KB)
- **Lines**: 199
- **Words**: 943
- **Characters**: 7,208
...
Markdown documentation file: **How to run gpt-oss locally with LM Studio**
...
**Same directory**:
- [fine-tune-korean.ipynb](./fine-tune-korean.ipynb_docs.md)
