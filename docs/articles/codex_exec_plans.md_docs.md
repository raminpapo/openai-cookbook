# Documentation: codex_exec_plans.md

## File Metadata
- **Path**: `articles/codex_exec_plans.md`
- **Type**: .md file
- **Size**: 16,357 bytes (15.97 KB)
- **Lines**: 179
- **Words**: 2,551
- **Characters**: 16,327
...
Markdown documentation file: **Using PLANS.md for multi-hour problem solving**
...
**Same directory**:
- [gpt-oss-safeguard-guide.md](./gpt-oss-safeguard-guide.md_docs.md)
- [how_to_work_with_large_language_models.md](./how_to_work_with_large_language_models.md_docs.md)
- [openai-harmony.md](./openai-harmony.md_docs.md)
- [related_resources.md](./related_resources.md_docs.md)
- [techniques_to_improve_reliability.md](./techniques_to_improve_reliability.md_docs.md)
- [text_comparison_examples.md](./text_comparison_examples.md_docs.md)
- [what_is_new_with_dalle_3.mdx](./what_is_new_with_dalle_3.mdx_docs.md)
- [what_makes_documentation_good.md](./what_makes_documentation_good.md_docs.md)
